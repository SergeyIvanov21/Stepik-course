...
![25 Задание](image/25.png){#fig:025 width=70%}

![26 Задание](image/26.png){#fig:026 width=70%}
...
![27 Задание](image/27.png){#fig:027 width=70%}
...
![28 Задание](image/28.png){#fig:028 width=70%}

-persist lets plot windows survive after main gnuplot program exits. 

![29 Задание](image/29.png){#fig:029 width=70%}
...
![30 Задание](image/30.png){#fig:030 width=70%}
...
![31 Задание](image/31.png){#fig:031 width=70%}
...
![32 Задание](image/32.png){#fig:032 width=70%}
...
![33 Задание](image/33.png){#fig:033 width=70%}
...
![34 Задание](image/34.png){#fig:034 width=70%}
...
![35 Задание](image/35.png){#fig:035 width=70%}
...
![36 Задание](image/36.png){#fig:036 width=70%}

Команда создаст три директории от dir1 до dir3. 

# Сертификат

https://stepik.org/cert/2466269

![Сертификат](image/sert.png){#fig:047 width=70%}
